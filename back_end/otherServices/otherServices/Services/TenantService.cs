...
namespace otherServices.Services
{
    public class TenantService : ITenantService
    {
        ...
        public TenantService( IWebHostEnvironment env, IProposalRepository proposalRepository, IPostRepository postRepository, ISavedPostRepository savedPostRepository)
        {
            _env = env;
